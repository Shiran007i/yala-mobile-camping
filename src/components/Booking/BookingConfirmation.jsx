...
import { CheckCircle, Mail, MessageCircle, Calendar, Users, MapPin, ArrowLeft, Download, Phone } from 'lucide-react';

const BookingConfirmation = ({ bookingDetails, onBackToBooking, onNewBooking }) => {
  if (!bookingDetails) {
    return null;
  }
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="bg-gradient-to-r from-emerald-500 to-green-600 rounded-2xl shadow-lg p-8 text-center mb-8 text-white">
        ...
        <h1 className="text-3xl font-bold mb-2">Booking Request Sent Successfully!</h1>
          ...
          <div>
            ...
            <div className="space-y-3 bg-gray-50 p-4 rounded-lg">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium">{groupSize} {groupSize === 1 ? 'Guest' : 'Guests'}</span>
              </div>
            </div>
          </div>
      ...
      <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="text-center p-6 bg-blue-50 rounded-lg">
            ...
            <h3 className="font-semibold text-gray-900 mb-2">Review & Confirmation</h3>
            <p className="text-sm text-gray-600">We'll review your request and confirm availability within 1-2 hours during business hours</p>
          </div>
          ...
          <div className="text-center p-6 bg-green-50 rounded-lg">
            ...
            <p className="text-sm text-gray-600">Once confirmed, we'll send secure payment instructions via WhatsApp or email</p>
          </div>
          ...
          <div className="text-center p-6 bg-emerald-50 rounded-lg">
            ...
            <p className="text-sm text-gray-600">Get ready for your amazing camping experience at Yala National Park!</p>
          </div>
        </div>

        {/* Timeline */}
        <div className="mt-8 bg-gray-50 p-6 rounded-lg">
          <h4 className="font-semibold text-gray-900 mb-4">Expected Timeline:</h4>
          <div className="space-y-2 text-sm">
            <div className="flex items-center">
              <div className="w-2 h-2 bg-blue-500 rounded-full mr-3"></div>
              <span><strong>Within 1-2 hours:</strong> Booking confirmation & availability check</span>
            </div>
            <div className="flex items-center">
              <div className="w-2 h-2 bg-green-500 rounded-full mr-3"></div>
              <span><strong>Within 24 hours:</strong> Payment instructions sent</span>
            </div>
            <div className="flex items-center">
              <div className="w-2 h-2 bg-emerald-500 rounded-full mr-3"></div>
              <span><strong>24-48 hours before arrival:</strong> Final details & directions</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <div className="bg-blue-50 p-6 rounded-lg border border-blue-200">
          ...
          <p className="text-sm text-blue-800 mb-3">
            Your booking request and confirmation details have been sent to your email address.
          </p>
        ...
        <div className="bg-green-50 p-6 rounded-lg border border-green-200">
          ...
          <p className="text-sm text-green-800 mb-3">
            We'll contact you via WhatsApp for quick updates and to answer any questions.
          </p>
      ...
      {/* Action Buttons */}
      <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
        <h3 className="text-lg font-semibold text-gray-900 mb-6">Manage Your Booking</h3>
      ...
      <div className="bg-red-50 border border-red-200 rounded-lg p-6">
        <h3 className="font-semibold text-red-900 mb-2">Need Immediate Assistance?</h3>
        <p className="text-sm text-red-800 mb-4">
          For urgent matters or last-minute changes, contact us directly:
        </p>
        <div className="flex flex-col sm:flex-row gap-4">
          <a
            href="tel:+94713991051"
