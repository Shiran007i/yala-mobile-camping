          ...
          <div className="col-span-1 lg:col-span-2">
            <div className="mb-6">
              ...
              <p className="text-slate-300 mb-4">
                Experience the wild like never before. Premium mobile camping
                adventures in Sri Lanka's most iconic national park.
              </p>
            </div>
              ...
              {subscribeMessage && (
                <p
                  className={`mt-2 text-sm ${
                    ...
                    subscribeMessage.includes("already subscribed")
                      ? "text-emerald-400"
                      : "text-red-400"
                  }`}
                >
            ...
            <div className="flex space-x-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-slate-700 hover:bg-emerald-400 p-2 rounded-md transition-colors duration-200"
            ...
            <div className="mt-8 pt-6">
              <div className="text-center">
                <p className="text-slate-500 text-sm mb-2">
                  Powered by{" "}
                  <span className="text-red-700 font-semibold">Artisan</span>
                </p>
                <p className="text-slate-600 text-xs">
                  "Crafting Digital Excellence Through IT Solutions & Strategic
                  Advertising"
                </p>
              </div>
            </div>
